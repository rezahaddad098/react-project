                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Alireza</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Natasha</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Reza Haddad</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
            </div>
